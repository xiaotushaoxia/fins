...
func defaultHeader(messageType uint8, responseRequired bool, src DeviceAddress, dst DeviceAddress, serviceID byte) Header {
	h := Header{}
...
func defaultCommandHeader(src DeviceAddress, dst DeviceAddress, serviceID byte) Header {
